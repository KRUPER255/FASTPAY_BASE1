  ...
  return (
    <>
      ...
      <CardContent className="p-3 flex flex-col flex-1 min-h-0">
        {/* Search Box - Hidden by default, shown when clicking search icon */}
        {searchQuery && (
          <div className="mb-3">
        ...
        {/* Hidden search input for focus */}
        <Input
          ref={searchInputRef}
          type="text"
          value={searchQuery}
          onChange={e => setSearchQuery(e.target.value)}
          className={cn('absolute opacity-0 pointer-events-none', searchQuery && 'hidden')}
                ...
                >
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      ...
                      <div
                        className={cn(
                          ...
                          isConnected ? 'bg-status-success' : 'bg-muted-foreground/60'
                        )}
                  ...
                  >
                    <div className="px-3 pb-3 pt-1 border-t border-border/30 space-y-2">
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-muted-foreground">BANKCODE:</span>
