...
import { DeviceSectionAssignmentPanel } from './DeviceSectionAssignmentPanel'
...
export function DeviceListSection({ onDeviceSelect, onAttachBankCard }: DeviceListSectionProps) {
